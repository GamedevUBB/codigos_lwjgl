...
public final class MD3Model {
	...
	public final void loadModel(String strPath, String strModel) {
		...
		System.out.println("MD3-Head: " + strHeadModel + " cargado");
		...
		System.out.println("MD3-Upper: " + strUpperModel + " cargado");
		...
		System.out.println("MD3-Lower: " + strLowerModel + " cargado");
		...
		System.out.println("MD3 Skin-Lower: " + strLowerSkin + " cargado");
		...
		System.out.println("MD3 Skin-Upper: " + strUpperSkin + " cargado");
		...
		System.out.println("MD3 Skin-Head: " + strHeadSkin + " cargado");

		  // Load the lower, upper and head textures.
		loadModelTextures(m_Lower, strPath);
		System.out.println("MD3 Texture-Lower: " + strPath + " cargado");
		loadModelTextures(m_Upper, strPath);
		System.out.println("MD3 Texture-Upper: " + strPath + " cargado");
		loadModelTextures(m_Head, strPath);
		System.out.println("MD3 Texture-Head: " + strPath + " cargado");
		...
		System.out.println("MD3 Animation: " + strConfigFile + " cargado");
	...
	private final void loadModelTextures(Model3D pModel, String strPath) {
		...
		for(int i = 0; i < pModel.numOfMaterials; i++)
		{
			...
			if(((MaterialInfo)pModel.pMaterials.elementAt(i)).strFile != null)
			{
				...
				System.out.println("MD3 Texture: " + strFullPath + " cargado");
	...
	private final void drawLink(Model3D pModel) {
		...
		final FloatBuffer finalMatrixBuffer = BufferUtils.createFloatBuffer(16);
			...
			if(pLink != null)
			{
				...
				finalMatrixBuffer.put(finalMatrix).rewind();
				  ...
				  GL11.glPushMatrix();
				    ...
				    GL11.glMultMatrixf(finalMatrixBuffer);
