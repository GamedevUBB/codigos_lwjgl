package org.lwjglb.normalMappingRenderer;
...
public class NormalMappingShader extends ShaderProgram {
	...
	private static final String VERTEX_FILE = new Config().getPath() + "/normalMappingRenderer/normalMapVShader.txt";
	private static final String FRAGMENT_FILE = new Config().getPath() + "/normalMappingRenderer/normalMapFShader.txt";
