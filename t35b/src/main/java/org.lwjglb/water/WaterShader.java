...
public class WaterShader extends ShaderProgram {
	...
	private int location_refrationTexture;
	...
	protected void getAllUniformLocations() {
		...
		location_refrationTexture = getUniformLocation("refractionTexture");
	...
	public void connectTextureUnits() {
		...
		super.loadInt(location_refrationTexture, 1);
